...
app.include_router(user_router, prefix="/github", tags=["Repositories Users or org"])
#app.include_router(repo_activity_router, prefix="/github", tags=["Repositories Activity"])
app.include_router(activity_router, prefix="/github", tags=["Repositories Activity"])
